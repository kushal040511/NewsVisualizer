...
public class ModernUIComponents {
    ...
    public static class ModernButton extends JButton {
        ...
        private void setupButton() {
            setFont(EnhancedModernTheme.Fonts.BUTTON);
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (isEnabled()) {
                EnhancedModernTheme.Shadows.applyCardShadow(g2d, width, height, EnhancedModernTheme.Radius.BUTTON);
            }
            ...
            if (!isEnabled()) {
                buttonColor = EnhancedModernTheme.Colors.GRAY_300;
            }
            
            g2d.setColor(buttonColor);
            g2d.fillRoundRect(0, 0, width, height, EnhancedModernTheme.Radius.BUTTON, EnhancedModernTheme.Radius.BUTTON);

            g2d.setColor(new Color(255, 255, 255, 28));
            g2d.setStroke(new BasicStroke(1.0f));
            g2d.drawRoundRect(0, 0, width - 1, height - 1, EnhancedModernTheme.Radius.BUTTON, EnhancedModernTheme.Radius.BUTTON);
    ...
    public static class ModernComboBox extends JComboBox<String> {
        ...
        private void setupComboBox() {
            setFont(EnhancedModernTheme.Fonts.BODY_MEDIUM);
            setBackground(EnhancedModernTheme.Colors.WHITE);
            setForeground(EnhancedModernTheme.Colors.TEXT_PRIMARY);
            setOpaque(false);
            setFocusable(true);
            setCursor(new Cursor(Cursor.HAND_CURSOR));
            ...
            setPreferredSize(new Dimension(220, EnhancedModernTheme.Layout.INPUT_HEIGHT));
            ...
            setRenderer(new DefaultListCellRenderer() {
                ...
                public Component getListCellRendererComponent(JList<?> list, Object value, int index,
                    ...
                    if (isSelected) {
                        label.setBackground(new Color(79, 70, 229, 22));
                        label.setForeground(EnhancedModernTheme.Colors.TEXT_PRIMARY);
                    } else {
                        label.setBackground(EnhancedModernTheme.Colors.WHITE);
                        label.setForeground(EnhancedModernTheme.Colors.TEXT_PRIMARY);
                    }
                    return label;
                }
            ...
            setUI(new BasicComboBoxUI() {
                ...
                protected JButton createArrowButton() {
                    ...
                    button.setForeground(EnhancedModernTheme.Colors.TEXT_SECONDARY);
                    return button;
                }
            });

            Object child = getAccessibleContext().getAccessibleChild(0);
            if (child instanceof JComponent popupComponent) {
                popupComponent.setBorder(new LineBorder(EnhancedModernTheme.Colors.BORDER_LIGHT, 1, true));
            }
        }
    }
    ...
    public static class ModernTextField extends JTextField {
        ...
        private void setupTextField() {
            ...
            setPreferredSize(new Dimension(getPreferredSize().width, EnhancedModernTheme.Layout.INPUT_HEIGHT));
        }
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Border
            g2d.setColor(hasFocus() ? EnhancedModernTheme.Colors.PRIMARY : EnhancedModernTheme.Colors.BORDER_DEFAULT);
            g2d.setStroke(new BasicStroke(hasFocus() ? 2.0f : 1.0f));
            g2d.drawRoundRect(1, 1, getWidth() - 2, getHeight() - 2, EnhancedModernTheme.Radius.BUTTON, EnhancedModernTheme.Radius.BUTTON);
    ...
    public static class ModernProgressBar extends JProgressBar {
        ...
        private void setupProgressBar() {
            ...
            setFont(EnhancedModernTheme.Fonts.BODY_SMALL);
            setForeground(EnhancedModernTheme.Colors.PRIMARY);
            setBackground(EnhancedModernTheme.Colors.GRAY_200);
            setBorderPainted(false);
            ...
            setUI(new BasicProgressBarUI() {
                ...
                protected void paintDeterminate(Graphics g, JComponent c) {
                    ...
                    // Background
                    g2d.setColor(EnhancedModernTheme.Colors.GRAY_200);
                    ...
                    if (progressWidth > 0) {
                        GradientPaint gradient = new GradientPaint(
                            0, 0, EnhancedModernTheme.Colors.PRIMARY_LIGHT,
                            progressWidth, 0, EnhancedModernTheme.Colors.PRIMARY
                        );
                ...
                protected void paintIndeterminate(Graphics g, JComponent c) {
                    ...
                    if (x < width && x + animationWidth > 0) {
                        GradientPaint gradient = new GradientPaint(
                            x, 0, new Color(EnhancedModernTheme.Colors.PRIMARY.getRed(), EnhancedModernTheme.Colors.PRIMARY.getGreen(), EnhancedModernTheme.Colors.PRIMARY.getBlue(), 100),
                            x + animationWidth, 0, new Color(EnhancedModernTheme.Colors.PRIMARY.getRed(), EnhancedModernTheme.Colors.PRIMARY.getGreen(), EnhancedModernTheme.Colors.PRIMARY.getBlue(), 0)
                        );
                        g2d.setPaint(gradient);
    ...
    public static class ModernCard extends JPanel {
        ...
        private void setupCard() {
            setOpaque(false);
            setBorder(new EmptyBorder(EnhancedModernTheme.Spacing.LARGE, EnhancedModernTheme.Spacing.LARGE,
                                    EnhancedModernTheme.Spacing.LARGE, EnhancedModernTheme.Spacing.LARGE));
        }
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Shadow
            if (showShadow) {
                EnhancedModernTheme.Shadows.applyCardShadow(g2d, width, height, EnhancedModernTheme.Radius.CARD);
            }
            
            g2d.setColor(EnhancedModernTheme.Colors.BACKGROUND_CARD);
            g2d.fillRoundRect(0, 0, width, height, EnhancedModernTheme.Radius.CARD, EnhancedModernTheme.Radius.CARD);
            
            g2d.setColor(EnhancedModernTheme.Colors.BORDER_LIGHT);
            g2d.setStroke(new BasicStroke(1.0f));
            g2d.drawRoundRect(0, 0, width - 1, height - 1, EnhancedModernTheme.Radius.CARD, EnhancedModernTheme.Radius.CARD);
            
            if (title != null && !title.isEmpty()) {
                g2d.setColor(EnhancedModernTheme.Colors.TEXT_PRIMARY);
                g2d.setFont(EnhancedModernTheme.Fonts.HEADING_MEDIUM);
                FontMetrics fm = g2d.getFontMetrics();
                int titleY = EnhancedModernTheme.Spacing.MEDIUM + fm.getAscent();
                g2d.drawString(title, EnhancedModernTheme.Spacing.MEDIUM, titleY);
            }
    ...
    public static ModernButton createPrimaryButton(String text) {
        return new ModernButton(text, EnhancedModernTheme.Colors.PRIMARY, EnhancedModernTheme.Colors.WHITE);
    }
    
    public static ModernButton createSecondaryButton(String text) {
        return new ModernButton(text, EnhancedModernTheme.Colors.SECONDARY, EnhancedModernTheme.Colors.WHITE);
    }
    
    public static ModernButton createAccentButton(String text) {
        return new ModernButton(text, EnhancedModernTheme.Colors.ACCENT, EnhancedModernTheme.Colors.WHITE);
    }
    
    public static ModernButton createOutlineButton(String text) {
        return new ModernButton(text, EnhancedModernTheme.Colors.WHITE, EnhancedModernTheme.Colors.PRIMARY);
    }
